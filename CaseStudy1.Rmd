...
beers = read_excel("~/Library/Mobile Documents/com~apple~CloudDocs/R-SMU/Beers.xlsx")
breweries = read_excel("~/Library/Mobile Documents/com~apple~CloudDocs/R-SMU/Breweries.xlsx")
```
